...
ORACLE_HOME=input("Oracle Home dir: (/u01/app/oracle/product/19.0.0/rdbms) : ") or "/u01/app/oracle/product/19.0.0/rdbms"
print(ORACLE_HOME)
...
Q_SOFT_NAME=input("Software binary name, should be (LINUX.X64_193000_client.zip) : ") or "LINUX.X64_193000_client.zip"
print(Q_SOFT_NAME)
